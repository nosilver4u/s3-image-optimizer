 ...
 */
class RegisterListenersPass implements \S3IO\Aws2\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\S3IO\Aws2\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->subscriberTag) as $id => $attributes) {
            ...
            $interface = 'S3IO\\Aws2\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface';
