 ...
 */
class TraceableEventDispatcher implements \S3IO\Aws2\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcherInterface
{
    protected $logger;
    protected $stopwatch;
    private $called;
    ...
    public function __construct(\S3IO\Aws2\Symfony\Component\EventDispatcher\EventDispatcherInterface $dispatcher, \S3IO\Aws2\Symfony\Component\Stopwatch\Stopwatch $stopwatch, \S3IO\Aws2\Psr\Log\LoggerInterface $logger = null)
    {
     ...
     * {@inheritdoc}
     */
    public function dispatch($eventName, \S3IO\Aws2\Symfony\Component\EventDispatcher\Event $event = null)
    {
        if (null === $event) {
            $event = new \S3IO\Aws2\Symfony\Component\EventDispatcher\Event();
        }
     ...
     */
    protected function preDispatch($eventName, \S3IO\Aws2\Symfony\Component\EventDispatcher\Event $event)
    {
    }
    /**
     ...
     * @param Event  $event     The event
     */
    protected function postDispatch($eventName, \S3IO\Aws2\Symfony\Component\EventDispatcher\Event $event)
    {
    }
    private function preProcess($eventName)
    {
        foreach ($this->dispatcher->getListeners($eventName) as $listener) {
            ...
            $wrappedListener = new \S3IO\Aws2\Symfony\Component\EventDispatcher\Debug\WrappedListener($listener, $name, $this->stopwatch, $this);
