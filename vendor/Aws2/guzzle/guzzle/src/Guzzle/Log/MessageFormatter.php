...
class MessageFormatter
{
     ...
     * @return string
     */
    public function format(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response = null, \S3IO\Aws2\Guzzle\Http\Curl\CurlHandle $handle = null, array $customData = array())
    {
        $cache = $customData;
