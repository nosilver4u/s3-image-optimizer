 ...
 */
class XmlVisitor extends \S3IO\Aws2\Guzzle\Service\Command\LocationVisitor\Response\AbstractResponseVisitor
{
     ...
     */
    protected function processArray(\S3IO\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
     ...
     * @param mixed     $value Value to process
     */
    protected function processObject(\S3IO\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
     ...
     */
    protected function processXmlAttribute(\S3IO\Aws2\Guzzle\Service\Description\Parameter $property, array &$value)
    {
        $sentAs = $property->getWireName();
