 ...
 */
class XmlVisitor extends \S3IO\Aws2\Guzzle\Service\Command\LocationVisitor\Request\AbstractRequestVisitor
{
     ...
     * @return \XMLWriter
     */
    protected function createRootElement(\S3IO\Aws2\Guzzle\Service\Description\Operation $operation)
    {
     ...
     */
    protected function addXml(\XMLWriter $xmlWriter, \S3IO\Aws2\Guzzle\Service\Description\Parameter $param, $value)
    {
        if ($value === null) {
            return;
        }
     ...
     */
    protected function addXmlArray(\XMLWriter $xmlWriter, \S3IO\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
     ...
     */
    protected function addXmlObject(\XMLWriter $xmlWriter, \S3IO\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
        $noAttributes = array();
