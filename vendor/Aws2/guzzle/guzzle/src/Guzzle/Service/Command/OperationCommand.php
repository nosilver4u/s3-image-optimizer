 ...
 */
class OperationCommand extends \S3IO\Aws2\Guzzle\Service\Command\AbstractCommand
{
     ...
     * @return self
     */
    public function setResponseParser(\S3IO\Aws2\Guzzle\Service\Command\ResponseParserInterface $parser)
    {
     ...
     * @return self
     */
    public function setRequestSerializer(\S3IO\Aws2\Guzzle\Service\Command\RequestSerializerInterface $serializer)
    {
    ...
    public function getRequestSerializer()
    {
        if (!$this->requestSerializer) {
            ...
            $this->requestSerializer = \S3IO\Aws2\Guzzle\Service\Command\DefaultRequestSerializer::getInstance();
        }
    ...
    public function getResponseParser()
    {
        if (!$this->responseParser) {
            ...
            $this->responseParser = \S3IO\Aws2\Guzzle\Service\Command\OperationResponseParser::getInstance();
        }
