 ...
 */
class BodyVisitor extends \S3IO\Aws2\Guzzle\Service\Command\LocationVisitor\Request\AbstractRequestVisitor
{
    public function visit(\S3IO\Aws2\Guzzle\Service\Command\CommandInterface $command, \S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Service\Description\Parameter $param, $value)
    {
        ...
        $entityBody = \S3IO\Aws2\Guzzle\Http\EntityBody::factory($value);
     ...
     */
    protected function addExpectHeader(\S3IO\Aws2\Guzzle\Http\Message\EntityEnclosingRequestInterface $request, \S3IO\Aws2\Guzzle\Http\EntityBodyInterface $body, $expect)
    {
