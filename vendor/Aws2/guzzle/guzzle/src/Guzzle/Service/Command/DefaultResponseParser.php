 ...
 */
class DefaultResponseParser implements \S3IO\Aws2\Guzzle\Service\Command\ResponseParserInterface
{
    /** @var self */
    ...
    public function parse(\S3IO\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
