 ...
 */
class SchemaValidator implements \S3IO\Aws2\Guzzle\Service\Description\ValidatorInterface
{
    ...
    public function validate(\S3IO\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
        $this->errors = array();
     ...
     */
    protected function recursiveProcess(\S3IO\Aws2\Guzzle\Service\Description\Parameter $param, &$value, $path = '', $depth = 0)
    {
