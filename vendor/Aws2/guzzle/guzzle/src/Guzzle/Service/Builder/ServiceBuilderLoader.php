 ...
 */
class ServiceBuilderLoader extends \S3IO\Aws2\Guzzle\Service\AbstractConfigLoader
{
        ...
        foreach ($services as $name => &$service) {
            ...
            if (!empty($service['extends'])) {
                ...
                if (!isset($services[$service['extends']])) {
                    throw new \S3IO\Aws2\Guzzle\Service\Exception\ServiceNotFoundException("{$name} is trying to extend a non-existent service: {$service['extends']}");
                }
