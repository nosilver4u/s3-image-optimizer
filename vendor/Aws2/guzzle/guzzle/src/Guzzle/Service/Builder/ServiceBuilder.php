...
namespace S3IO\Aws2\Guzzle\Service\Builder;

use S3IO\Aws2\Guzzle\Common\AbstractHasDispatcher;
use S3IO\Aws2\Guzzle\Service\ClientInterface;
use S3IO\Aws2\Guzzle\Service\Exception\ServiceBuilderException;
use S3IO\Aws2\Guzzle\Service\Exception\ServiceNotFoundException;
 ...
 */
class ServiceBuilder extends \S3IO\Aws2\Guzzle\Common\AbstractHasDispatcher implements \S3IO\Aws2\Guzzle\Service\Builder\ServiceBuilderInterface, \ArrayAccess, \Serializable
{
    ...
    public static function factory($config = null, array $globalParameters = array())
    {
        ...
        if (!static::$cachedFactory) {
            static::$cachedFactory = new \S3IO\Aws2\Guzzle\Service\Builder\ServiceBuilderLoader();
        }
     ...
     * @return self
     */
    public function addGlobalPlugin(\S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface $plugin)
    {
        $this->plugins[] = $plugin;
        return $this;
    }
    ...
    public function get($name, $throwAway = false)
    {
        if (!isset($this->builderConfig[$name])) {
            ...
            throw new \S3IO\Aws2\Guzzle\Service\Exception\ServiceNotFoundException('No service is registered as ' . $name);
        }
