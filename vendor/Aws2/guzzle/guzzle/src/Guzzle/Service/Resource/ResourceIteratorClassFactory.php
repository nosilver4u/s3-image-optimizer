 ...
 */
class ResourceIteratorClassFactory extends \S3IO\Aws2\Guzzle\Service\Resource\AbstractResourceIteratorFactory
{
    ...
    protected function getClassName(\S3IO\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
