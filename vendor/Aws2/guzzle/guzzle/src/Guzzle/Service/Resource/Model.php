 ...
 */
class Model extends \S3IO\Aws2\Guzzle\Common\Collection
{
     ...
     */
    public function __construct(array $data = array(), \S3IO\Aws2\Guzzle\Service\Description\Parameter $structure = null)
    {
        $this->data = $data;
    ...
    {
        return $this->structure ?: new \S3IO\Aws2\Guzzle\Service\Description\Parameter();
    }
    /**
