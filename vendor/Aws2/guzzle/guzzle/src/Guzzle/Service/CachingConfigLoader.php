 ...
 */
class CachingConfigLoader implements \S3IO\Aws2\Guzzle\Service\ConfigLoaderInterface
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Service\ConfigLoaderInterface $loader, \S3IO\Aws2\Guzzle\Cache\CacheAdapterInterface $cache)
    {
        $this->loader = $loader;
        $this->cache = $cache;
    }
