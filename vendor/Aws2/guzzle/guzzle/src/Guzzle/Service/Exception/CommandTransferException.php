 ...
 */
class CommandTransferException extends \S3IO\Aws2\Guzzle\Http\Exception\MultiTransferException
{
     ...
     * @return self
     */
    public static function fromMultiTransferException(\S3IO\Aws2\Guzzle\Http\Exception\MultiTransferException $e)
    {
     ...
     * @return self
     */
    public function addSuccessfulCommand(\S3IO\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
     ...
     * @return self
     */
    public function addFailedCommand(\S3IO\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
     ...
     */
    public function getExceptionForFailedCommand(\S3IO\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
