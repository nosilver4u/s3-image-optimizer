...
namespace S3IO\Aws2\Guzzle\Stream;
 ...
 */
class PhpStreamRequestFactory implements \S3IO\Aws2\Guzzle\Stream\StreamRequestFactoryInterface
{
     ...
     */
    public function fromRequest(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, $context = array(), array $params = array())
    {
        if (is_resource($context)) {
            ...
            throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('$context must be an array or resource');
        }
     ...
     */
    protected function addDefaultContextOptions(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     */
    protected function setUrl(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @param RequestInterface $request Request
     */
    protected function addSslOptions(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     */
    protected function addBodyOptions(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @param RequestInterface $request Request
     */
    protected function addProxyOptions(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     */
    protected function processResponseHeaders(\S3IO\Aws2\Guzzle\Stream\StreamInterface $stream)
    {
    ...
    protected function createResource($callback)
    {
        ...
        if (!$resource) {
            ...
            throw new \S3IO\Aws2\Guzzle\Common\Exception\RuntimeException(trim($message));
        }
        return $resource;
    }
}
