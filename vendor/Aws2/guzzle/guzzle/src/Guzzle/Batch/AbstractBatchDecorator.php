 ...
 */
abstract class AbstractBatchDecorator implements \S3IO\Aws2\Guzzle\Batch\BatchInterface
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Batch\BatchInterface $decoratedBatch)
    {
