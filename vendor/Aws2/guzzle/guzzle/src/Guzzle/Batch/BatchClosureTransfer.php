 ...
 */
class BatchClosureTransfer implements \S3IO\Aws2\Guzzle\Batch\BatchTransferInterface
{
    ...
    public function __construct($callable, $context = null)
    {
        if (!is_callable($callable)) {
            throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Argument must be callable');
        }
