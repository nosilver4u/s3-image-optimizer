...
use S3IO\Aws2\Guzzle\Batch\Exception\BatchTransferException;
/**
 ...
 */
class Batch implements \S3IO\Aws2\Guzzle\Batch\BatchInterface
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Batch\BatchTransferInterface $transferStrategy, \S3IO\Aws2\Guzzle\Batch\BatchDivisorInterface $divisionStrategy)
    {
        ...
        foreach ($this->dividedBatches as $batchIndex => $dividedBatch) {
            while ($dividedBatch->valid()) {
                ...
                try {
                    ...
                    throw new \S3IO\Aws2\Guzzle\Batch\Exception\BatchTransferException($batch, $items, $e, $this->transferStrategy, $this->divisionStrategy);
                }
            }
