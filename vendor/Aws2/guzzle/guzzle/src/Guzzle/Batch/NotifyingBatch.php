 ...
 */
class NotifyingBatch extends \S3IO\Aws2\Guzzle\Batch\AbstractBatchDecorator
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Batch\BatchInterface $decoratedBatch, $callable)
    {
        if (!is_callable($callable)) {
            throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('The passed argument is not callable');
        }
