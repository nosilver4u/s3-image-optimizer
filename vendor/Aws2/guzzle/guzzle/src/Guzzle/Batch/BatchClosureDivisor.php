 ...
 */
class BatchClosureDivisor implements \S3IO\Aws2\Guzzle\Batch\BatchDivisorInterface
{
    ...
    public function __construct($callable, $context = null)
    {
        if (!is_callable($callable)) {
            throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Must pass a callable');
        }
