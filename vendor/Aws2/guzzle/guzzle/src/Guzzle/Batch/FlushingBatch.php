 ...
 */
class FlushingBatch extends \S3IO\Aws2\Guzzle\Batch\AbstractBatchDecorator
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Batch\BatchInterface $decoratedBatch, $threshold)
    {
