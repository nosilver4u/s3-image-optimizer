...
namespace S3IO\Aws2\Guzzle\Batch\Exception;

use S3IO\Aws2\Guzzle\Common\Exception\GuzzleException;
use S3IO\Aws2\Guzzle\Batch\BatchTransferInterface as TransferStrategy;
use S3IO\Aws2\Guzzle\Batch\BatchDivisorInterface as DivisorStrategy;
/**
 * Exception thrown during a batch transfer
 */
class BatchTransferException extends \Exception implements \S3IO\Aws2\Guzzle\Common\Exception\GuzzleException
{
     ...
     */
    public function __construct(array $batch, array $transferredItems, \Exception $exception, \S3IO\Aws2\Guzzle\Batch\BatchTransferInterface $transferStrategy = null, \S3IO\Aws2\Guzzle\Batch\BatchDivisorInterface $divisorStrategy = null)
    {
        $this->batch = $batch;
