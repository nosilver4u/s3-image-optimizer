 ...
 */
class BatchRequestTransfer implements \S3IO\Aws2\Guzzle\Batch\BatchTransferInterface, \S3IO\Aws2\Guzzle\Batch\BatchDivisorInterface
{
    ...
    public function createBatches(\SplQueue $queue)
    {
        ...
        foreach ($queue as $item) {
            if (!$item instanceof RequestInterface) {
                throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('All items must implement Guzzle\\Http\\Message\\RequestInterface');
            }
