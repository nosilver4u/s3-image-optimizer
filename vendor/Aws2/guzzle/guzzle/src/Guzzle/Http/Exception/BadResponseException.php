 ...
 */
class BadResponseException extends \S3IO\Aws2\Guzzle\Http\Exception\RequestException
{
    /** @var Response */
    private $response;
    /**
     ...
     */
    public static function factory(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response)
    {
     ...
     */
    public function setResponse(\S3IO\Aws2\Guzzle\Http\Message\Response $response)
    {
