 ...
 */
class CurlException extends \S3IO\Aws2\Guzzle\Http\Exception\RequestException
{
    private $curlError;
    private $curlErrorNo;
    private $handle;
     ...
     * @return self
     */
    public function setCurlHandle(\S3IO\Aws2\Guzzle\Http\Curl\CurlHandle $handle)
    {
        $this->handle = $handle;
        return $this;
    }
