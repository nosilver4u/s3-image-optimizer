 ...
 */
class MultiTransferException extends \S3IO\Aws2\Guzzle\Common\Exception\ExceptionCollection
{
     ...
     * @return self
     */
    public function addSuccessfulRequest(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return self
     */
    public function addFailedRequest(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return self
     */
    public function addFailedRequestWithException(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \Exception $exception)
    {
     ...
     */
    public function getExceptionForFailedRequest(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return bool
     */
    public function containsRequest(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
