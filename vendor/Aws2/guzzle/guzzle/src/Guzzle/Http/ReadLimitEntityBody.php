...
use S3IO\Aws2\Guzzle\Stream\StreamInterface;
/**
 * EntityBody decorator used to return only a subset of an entity body
 */
class ReadLimitEntityBody extends \S3IO\Aws2\Guzzle\Http\AbstractEntityBodyDecorator
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Http\EntityBodyInterface $body, $limit, $offset = 0)
    {
