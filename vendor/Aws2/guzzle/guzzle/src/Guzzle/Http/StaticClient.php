...
use S3IO\Aws2\Guzzle\Http\Client;
use S3IO\Aws2\Guzzle\Http\ClientInterface;
use S3IO\Aws2\Guzzle\Stream\StreamRequestFactoryInterface;
...
final class StaticClient
{
     ...
     */
    public static function mount($className = 'Guzzle', \S3IO\Aws2\Guzzle\Http\ClientInterface $client = null)
    {
    ...
    public static function request($method, $url, $options = array())
    {
        ...
        if (!self::$client) {
            self::$client = new \S3IO\Aws2\Guzzle\Http\Client();
        }
        ...
        if (isset($options['stream'])) {
            if ($options['stream'] instanceof StreamRequestFactoryInterface) {
                ...
                $streamFactory = new \S3IO\Aws2\Guzzle\Stream\PhpStreamRequestFactory();
