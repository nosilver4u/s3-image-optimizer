 ...
 */
class CurlMultiProxy extends \S3IO\Aws2\Guzzle\Common\AbstractHasDispatcher implements \S3IO\Aws2\Guzzle\Http\Curl\CurlMultiInterface
{
    ...
    public function __construct($maxHandles = 3, $selectTimeout = 1.0)
    {
        ...
        class_exists('S3IO\\Aws2\\Guzzle\\Http\\Message\\Response');
        class_exists('S3IO\\Aws2\\Guzzle\\Http\\Exception\\CurlException');
    }
    ...
    protected function getAvailableHandle()
    {
        ...
        $handle = new \S3IO\Aws2\Guzzle\Http\Curl\CurlMulti($this->selectTimeout);
