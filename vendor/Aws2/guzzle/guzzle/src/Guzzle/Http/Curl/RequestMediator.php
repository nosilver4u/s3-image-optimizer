...
class RequestMediator
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, $emitIo = false)
    {
    ...
    public function receiveResponseHeader($curl, $header)
    {
        ...
        if (strpos($header, 'HTTP/') === 0) {
            ...
            $response = new \S3IO\Aws2\Guzzle\Http\Message\Response($code, null, $body);
