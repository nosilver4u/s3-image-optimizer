 ...
 */
class EntityBody extends \S3IO\Aws2\Guzzle\Stream\Stream implements \S3IO\Aws2\Guzzle\Http\EntityBodyInterface
{
    ...
    public static function factory($resource = '', $size = null)
    {
        ...
        throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Invalid resource type');
    }
    public function setRewindFunction($callable)
    {
        if (!is_callable($callable)) {
            throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Must specify a callable');
        }
    ...
    {
        return $this->getUri() ? \S3IO\Aws2\Guzzle\Http\Mimetypes::getInstance()->fromFilename($this->getUri()) : null;
    }
     ...
     * @codeCoverageIgnore
     */
    public static function calculateMd5(\S3IO\Aws2\Guzzle\Http\EntityBodyInterface $body, $rawOutput = false, $base64Encode = false)
    {
        \S3IO\Aws2\Guzzle\Common\Version::warn(__CLASS__ . ' is deprecated. Use getContentMd5()');
