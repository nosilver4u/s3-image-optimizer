 ...
 */
class HeaderCollection implements \IteratorAggregate, \Countable, \ArrayAccess, \S3IO\Aws2\Guzzle\Common\ToArrayInterface
{
    /** @var array */
    protected $headers;
     ...
     * @return self
     */
    public function add(\S3IO\Aws2\Guzzle\Http\Message\Header\HeaderInterface $header)
    {
