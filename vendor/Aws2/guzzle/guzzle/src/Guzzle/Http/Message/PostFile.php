 ...
 * POST file upload
 */
class PostFile implements \S3IO\Aws2\Guzzle\Http\Message\PostFileInterface
{
    protected $fieldName;
    ...
    {
        \S3IO\Aws2\Guzzle\Common\Version::warn(__METHOD__ . ' is deprecated. Use getCurlValue()');
    ...
    {
        return \S3IO\Aws2\Guzzle\Http\Mimetypes::getInstance()->fromFilename($this->filename) ?: 'application/octet-stream';
    }
}
