 ...
 */
class Zf2CacheAdapter extends \S3IO\Aws2\Guzzle\Cache\AbstractCacheAdapter
{
    /**
     * @param StorageInterface $cache Zend Framework 2 cache adapter
     */
    public function __construct(\S3IO\Aws2\Zend\Cache\Storage\StorageInterface $cache)
    {
        $this->cache = $cache;
    }
