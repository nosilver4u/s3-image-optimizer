 ...
 * @codeCoverageIgnore
 */
class Zf1CacheAdapter extends \S3IO\Aws2\Guzzle\Cache\AbstractCacheAdapter
{
    /**
    ...
    {
        \S3IO\Aws2\Guzzle\Common\Version::warn(__CLASS__ . ' is deprecated. Upgrade to ZF2 or use PsrCacheAdapter');
        $this->cache = $cache;
    }
