 ...
 */
abstract class AbstractBackoffStrategy implements \S3IO\Aws2\Guzzle\Plugin\Backoff\BackoffStrategyInterface
{
    /** @var AbstractBackoffStrategy Next strategy in the chain */
    protected $next;
    /** @param AbstractBackoffStrategy $next Next strategy in the chain */
    public function setNext(\S3IO\Aws2\Guzzle\Plugin\Backoff\AbstractBackoffStrategy $next)
    {
        $this->next = $next;
    }
    /**
    ...
    public function getBackoffPeriod($retries, \S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response = null, \S3IO\Aws2\Guzzle\Http\Exception\HttpException $e = null)
    {
     ...
     */
    protected abstract function getDelay($retries, \S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response = null, \S3IO\Aws2\Guzzle\Http\Exception\HttpException $e = null);
}
