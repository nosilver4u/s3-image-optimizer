...
namespace S3IO\Aws2\Guzzle\Plugin\History;
 ...
 */
class HistoryPlugin implements \S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface, \IteratorAggregate, \Countable
{
     ...
     */
    public function add(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response = null)
    {
