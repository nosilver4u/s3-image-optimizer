...
namespace S3IO\Aws2\Guzzle\Plugin\Cookie;

use S3IO\Aws2\Guzzle\Common\Event;
use S3IO\Aws2\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar;
use S3IO\Aws2\Guzzle\Plugin\Cookie\CookieJar\CookieJarInterface;
use S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface;
/**
 * Adds, extracts, and persists cookies between HTTP requests
 */
class CookiePlugin implements \S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Plugin\Cookie\CookieJar\CookieJarInterface $cookieJar = null)
    {
        $this->cookieJar = $cookieJar ?: new \S3IO\Aws2\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar();
    }
