 ...
 */
class FileCookieJar extends \S3IO\Aws2\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar
{
    /** @var string filename */
    protected $filename;
    /**
    ...
    protected function persist()
    {
        if (false === file_put_contents($this->filename, $this->serialize())) {
            ...
            throw new \S3IO\Aws2\Guzzle\Common\Exception\RuntimeException('Unable to open file ' . $this->filename);
