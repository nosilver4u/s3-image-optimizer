...
namespace S3IO\Aws2\Guzzle\Plugin\CurlAuth;
 ...
 */
class CurlAuthPlugin implements \S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $username;
    private $password;
    private $scheme;
    ...
    {
        \S3IO\Aws2\Guzzle\Common\Version::warn(__CLASS__ . " is deprecated. Use \$client->getConfig()->setPath('request.options/auth', array('user', 'pass', 'Basic|Digest');");
     ...
     * @param Event $event
     */
    public function onRequestCreate(\S3IO\Aws2\Guzzle\Common\Event $event)
    {
