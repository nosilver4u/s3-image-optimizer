 ...
 */
class CommandContentMd5Plugin implements \S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function onCommandBeforeSend(\S3IO\Aws2\Guzzle\Common\Event $event)
    {
        ...
        if ($command[$this->validateMd5Param] === true) {
            $request->addSubscriber(new \S3IO\Aws2\Guzzle\Plugin\Md5\Md5ValidatorPlugin(true, false));
        }
    }
}
