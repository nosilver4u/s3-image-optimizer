 ...
 */
class CallbackCanCacheStrategy extends \S3IO\Aws2\Guzzle\Plugin\Cache\DefaultCanCacheStrategy
{
    ...
    public function __construct($requestCallback = null, $responseCallback = null)
    {
        if ($requestCallback && !is_callable($requestCallback)) {
            throw new \S3IO\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Method must be callable');
        }
