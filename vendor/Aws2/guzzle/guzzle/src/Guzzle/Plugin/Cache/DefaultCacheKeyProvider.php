...
\S3IO\Aws2\Guzzle\Common\Version::warn('S3IO\\Aws2\\Guzzle\\Plugin\\Cache\\DefaultCacheKeyProvider is no longer used');
/**
 * @deprecated This class is no longer used
 * @codeCoverageIgnore
 */
class DefaultCacheKeyProvider implements \S3IO\Aws2\Guzzle\Plugin\Cache\CacheKeyProviderInterface
{
    public function getCacheKey(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
