...
namespace S3IO\Aws2\Guzzle\Parser;
...
class ParserRegistry
{
    ...
    protected $mapping = array('message' => 'S3IO\\Aws2\\Guzzle\\Parser\\Message\\MessageParser', 'cookie' => 'S3IO\\Aws2\\Guzzle\\Parser\\Cookie\\CookieParser', 'url' => 'S3IO\\Aws2\\Guzzle\\Parser\\Url\\UrlParser', 'uri_template' => 'S3IO\\Aws2\\Guzzle\\Parser\\UriTemplate\\UriTemplate');
    /**
     * @return self
     * @codeCoverageIgnore
     */
    ...
    public function __construct()
    {
        ...
        if (extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'S3IO\\Aws2\\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
    /**
