...
namespace S3IO\Aws2\Guzzle\Parser\Url;
 ...
 * @codeCoverageIgnore
 */
class UrlParser implements \S3IO\Aws2\Guzzle\Parser\Url\UrlParserInterface
{
    ...
    {
        \S3IO\Aws2\Guzzle\Common\Version::warn(__CLASS__ . ' is deprecated. Just use parse_url()');
