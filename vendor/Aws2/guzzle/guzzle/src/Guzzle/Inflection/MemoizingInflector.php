 ...
 */
class MemoizingInflector implements \S3IO\Aws2\Guzzle\Inflection\InflectorInterface
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Inflection\InflectorInterface $inflector, $maxCacheSize = 500)
    {
