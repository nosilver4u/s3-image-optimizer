...
namespace S3IO\Aws2\Guzzle\Inflection;

/**
 * Decorator used to add pre-computed inflection mappings to an inflector
 */
class PreComputedInflector implements \S3IO\Aws2\Guzzle\Inflection\InflectorInterface
{
     ...
     */
    public function __construct(\S3IO\Aws2\Guzzle\Inflection\InflectorInterface $inflector, array $snake = array(), array $camel = array(), $mirror = false)
    {
        if ($mirror) {
