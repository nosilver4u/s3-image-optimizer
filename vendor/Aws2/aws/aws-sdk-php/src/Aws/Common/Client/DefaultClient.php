 ...
 */
class DefaultClient extends \S3IO\Aws2\Aws\Common\Client\AbstractClient
{
    /**
    ...
    {
        return \S3IO\Aws2\Aws\Common\Client\ClientBuilder::factory()->setConfig($config)->setConfigDefaults(array(\S3IO\Aws2\Aws\Common\Enum\ClientOptions::SCHEME => 'https'))->build();
    }
}
