 ...
 */
namespace S3IO\Aws2\Aws\Common\InstanceMetadata\Waiter;

use S3IO\Aws2\Aws\Common\Waiter\AbstractResourceWaiter;
 ...
 * @codeCoverageIgnore
 */
class ServiceAvailable extends \S3IO\Aws2\Aws\Common\Waiter\AbstractResourceWaiter
{
