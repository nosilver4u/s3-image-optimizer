 ...
 */
namespace S3IO\Aws2\Aws\Common;

use S3IO\Aws2\Aws\Common\Facade\Facade;
use S3IO\Aws2\Guzzle\Service\Builder\ServiceBuilder;
use S3IO\Aws2\Guzzle\Service\Builder\ServiceBuilderLoader;
/**
 * Base class for interacting with web service clients
 */
class Aws extends \S3IO\Aws2\Guzzle\Service\Builder\ServiceBuilder
{
    /**
    ...
    public static function factory($config = null, array $globalParameters = array())
    {
        ...
        $loader = new \S3IO\Aws2\Guzzle\Service\Builder\ServiceBuilderLoader();
    ...
    {
        \S3IO\Aws2\Aws\Common\Facade\Facade::mountFacades($this, $namespace);
        return $this;
    }
}
