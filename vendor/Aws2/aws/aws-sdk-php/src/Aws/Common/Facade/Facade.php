 ...
 */
abstract class Facade implements \S3IO\Aws2\Aws\Common\Facade\FacadeInterface
{
    /** @var Aws */
     ...
     */
    public static function mountFacades(\S3IO\Aws2\Aws\Common\Aws $serviceBuilder, $targetNamespace = null)
    {
