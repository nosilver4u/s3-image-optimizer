 ...
 */
class CompositeWaiterFactory implements \S3IO\Aws2\Aws\Common\Waiter\WaiterFactoryInterface
{
    /**
     ...
     * @return self
     */
    public function addFactory(\S3IO\Aws2\Aws\Common\Waiter\WaiterFactoryInterface $factory)
    {
