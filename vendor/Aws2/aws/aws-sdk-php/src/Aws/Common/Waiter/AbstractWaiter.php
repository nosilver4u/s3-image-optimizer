 ...
 */
abstract class AbstractWaiter extends \S3IO\Aws2\Guzzle\Common\AbstractHasDispatcher implements \S3IO\Aws2\Aws\Common\Waiter\WaiterInterface
{
    ...
    public function wait()
    {
        ...
        do {
            ...
            if (++$this->attempts >= $this->getMaxAttempts()) {
                throw new \S3IO\Aws2\Aws\Common\Exception\RuntimeException('Wait method never resolved to true after ' . $this->attempts . ' attempts');
            }
