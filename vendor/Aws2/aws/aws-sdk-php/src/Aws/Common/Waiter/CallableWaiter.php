 ...
 */
class CallableWaiter extends \S3IO\Aws2\Aws\Common\Waiter\AbstractWaiter
{
    /**
    ...
    public function setCallable($callable)
    {
        if (!is_callable($callable)) {
            throw new \S3IO\Aws2\Aws\Common\Exception\InvalidArgumentException('Value is not callable');
        }
    ...
    {
        if (!$this->callable) {
            throw new \S3IO\Aws2\Aws\Common\Exception\RuntimeException('No callable was specified for the wait method');
        }
