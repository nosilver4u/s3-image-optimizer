 ...
 */
abstract class AbstractUploadPart implements \S3IO\Aws2\Aws\Common\Model\MultipartUpload\UploadPartInterface
{
    /**
    ...
    protected function loadData($data)
    {
        foreach (static::$keyMap as $key => $property) {
            if (isset($data[$key])) {
                ...
                throw new \S3IO\Aws2\Aws\Common\Exception\InvalidArgumentException("A required key [{$key}] was missing from the upload part.");
            }
        }
    }
}
