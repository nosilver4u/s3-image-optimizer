 ...
 */
abstract class AbstractTransferState implements \S3IO\Aws2\Aws\Common\Model\MultipartUpload\TransferStateInterface
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Model\MultipartUpload\UploadIdInterface $uploadId)
    {
     ...
     * {@inheritdoc}
     */
    public function addPart(\S3IO\Aws2\Aws\Common\Model\MultipartUpload\UploadPartInterface $part)
    {
    ...
    public function unserialize($serialized)
    {
        ...
        foreach (get_object_vars($this) as $property => $oldValue) {
            if (array_key_exists($property, $data)) {
                ...
                throw new \S3IO\Aws2\Aws\Common\Exception\RuntimeException("The {$property} property could be restored during unserialization.");
            }
        }
    }
}
