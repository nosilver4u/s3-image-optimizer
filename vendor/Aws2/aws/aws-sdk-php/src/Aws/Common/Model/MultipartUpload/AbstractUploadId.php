 ...
 */
abstract class AbstractUploadId implements \S3IO\Aws2\Aws\Common\Model\MultipartUpload\UploadIdInterface
{
    /**
    ...
    protected function loadData($data)
    {
        ...
        foreach ($data as $key => $value) {
            if (isset($data[$key])) {
                ...
                throw new \S3IO\Aws2\Aws\Common\Exception\InvalidArgumentException("A required key [{$key}] was missing from the UploadId.");
            }
        }
    }
}
