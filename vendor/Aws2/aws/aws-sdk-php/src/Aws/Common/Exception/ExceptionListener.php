 ...
 */
class ExceptionListener implements \S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Exception\ExceptionFactoryInterface $factory)
    {
