...
use S3IO\Aws2\Aws\Common\Model\MultipartUpload\TransferStateInterface;
/**
 * Thrown when a {@see Aws\Common\MultipartUpload\TransferInterface} object encounters an error during transfer
 */
class MultipartUploadException extends \S3IO\Aws2\Aws\Common\Exception\RuntimeException
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Model\MultipartUpload\TransferStateInterface $state, \Exception $exception = null)
    {
