 ...
 */
abstract class AbstractJsonExceptionParser implements \S3IO\Aws2\Aws\Common\Exception\Parser\ExceptionParserInterface
{
    /**
     * {@inheritdoc}
     */
     ...
     * @return array
     */
    protected abstract function doParse(array $data, \S3IO\Aws2\Guzzle\Http\Message\Response $response);
}
