 ...
 */
namespace S3IO\Aws2\Aws\Common\Exception;
 ...
 */
class NamespaceExceptionFactory implements \S3IO\Aws2\Aws\Common\Exception\ExceptionFactoryInterface
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Exception\Parser\ExceptionParserInterface $parser, $baseNamespace, $defaultException = 'S3IO\\Aws2\\Aws\\Common\\Exception\\ServiceResponseException')
    {
        $this->parser = $parser;
     ...
     * {@inheritdoc}
     */
    public function fromResponse(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response)
    {
     ...
     * @return \Exception
     */
    protected function createException($className, \S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response, array $parts)
    {
