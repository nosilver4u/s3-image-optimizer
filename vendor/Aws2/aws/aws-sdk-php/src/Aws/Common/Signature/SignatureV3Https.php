 ...
 */
class SignatureV3Https extends \S3IO\Aws2\Aws\Common\Signature\AbstractSignature
{
    public function signRequest(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Aws\Common\Credentials\CredentialsInterface $credentials)
    {
        ...
        if (!$request->hasHeader('date') && !$request->hasHeader('x-amz-date')) {
            $request->setHeader('Date', gmdate(\S3IO\Aws2\Aws\Common\Enum\DateFormat::RFC1123, $this->getTimestamp()));
        }
