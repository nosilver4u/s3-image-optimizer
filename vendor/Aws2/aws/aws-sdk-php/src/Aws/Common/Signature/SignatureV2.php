 ...
 */
class SignatureV2 extends \S3IO\Aws2\Aws\Common\Signature\AbstractSignature
{
     ...
     */
    public function addParameter(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, $key, $value)
    {
     ...
     * @return string
     */
    private function getCanonicalizedParameterString(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
        if ($request->getMethod() == 'POST') {
