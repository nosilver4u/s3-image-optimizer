...
use S3IO\Aws2\Aws\Common\Credentials\AbstractRefreshableCredentials;
 ...
 */
class SignatureListener implements \S3IO\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Credentials\CredentialsInterface $credentials, \S3IO\Aws2\Aws\Common\Signature\SignatureInterface $signature)
    {
     ...
     */
    public function onCredentialsChanged(\S3IO\Aws2\Guzzle\Common\Event $event)
    {
