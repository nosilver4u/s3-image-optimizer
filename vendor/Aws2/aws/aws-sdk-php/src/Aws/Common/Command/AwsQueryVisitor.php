...
use S3IO\Aws2\Guzzle\Service\Command\LocationVisitor\Request\AbstractRequestVisitor;
/**
 * Location visitor used to serialize AWS query parameters (e.g. EC2, SES, SNS, SQS, etc) as POST fields
 */
class AwsQueryVisitor extends \S3IO\Aws2\Guzzle\Service\Command\LocationVisitor\Request\AbstractRequestVisitor
{
    private $fqname;
     ...
     */
    protected function customResolver($value, \S3IO\Aws2\Guzzle\Service\Description\Parameter $param, array &$query, $prefix = '')
    {
     ...
     */
    protected function resolveObject(\S3IO\Aws2\Guzzle\Service\Description\Parameter $param, array $value, $prefix, array &$query)
    {
     ...
     * @param array     $query  Query string array passed by reference
     */
    protected function resolveArray(\S3IO\Aws2\Guzzle\Service\Description\Parameter $param, array $value, $prefix, array &$query)
    {
