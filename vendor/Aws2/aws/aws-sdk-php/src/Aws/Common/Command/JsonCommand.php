 ...
 */
class JsonCommand extends \S3IO\Aws2\Guzzle\Service\Command\OperationCommand
{
    /**
     * {@inheritdoc}
     */
    protected function build()
    {
        ...
        $this->request->getCurlOptions()->set(\S3IO\Aws2\Guzzle\Http\Curl\CurlHandle::BODY_AS_STRING, true);
    }
}
