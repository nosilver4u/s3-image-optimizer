 ...
 */
class QueryCommand extends \S3IO\Aws2\Guzzle\Service\Command\OperationCommand
{
    /**
     * @var AwsQueryVisitor
     */
    ...
    protected function init()
    {
        ...
        if (!self::$queryVisitor) {
            self::$queryVisitor = new \S3IO\Aws2\Aws\Common\Command\AwsQueryVisitor();
        }
        if (!self::$xmlVisitor) {
            self::$xmlVisitor = new \S3IO\Aws2\Aws\Common\Command\XmlResponseLocationVisitor();
        }
