 ...
 */
class CacheableCredentials extends \S3IO\Aws2\Aws\Common\Credentials\AbstractRefreshableCredentials
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Credentials\CredentialsInterface $credentials, \S3IO\Aws2\Guzzle\Cache\CacheAdapterInterface $cache, $cacheKey)
    {
        $this->cache = $cache;
