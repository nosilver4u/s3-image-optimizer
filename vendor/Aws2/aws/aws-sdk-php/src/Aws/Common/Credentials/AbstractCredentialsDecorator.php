 ...
 */
class AbstractCredentialsDecorator implements \S3IO\Aws2\Aws\Common\Credentials\CredentialsInterface
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Credentials\CredentialsInterface $credentials)
    {
    ...
    {
        $this->credentials = new \S3IO\Aws2\Aws\Common\Credentials\Credentials('', '');
