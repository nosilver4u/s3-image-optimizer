...
use S3IO\Aws2\Aws\Common\InstanceMetadata\InstanceMetadataClient;
 ...
 * EC2 metadata server
 */
class RefreshableInstanceProfileCredentials extends \S3IO\Aws2\Aws\Common\Credentials\AbstractRefreshableCredentials
{
    /**
     ...
     */
    public function __construct(\S3IO\Aws2\Aws\Common\Credentials\CredentialsInterface $credentials, \S3IO\Aws2\Aws\Common\InstanceMetadata\InstanceMetadataClient $client = null)
    {
        parent::__construct($credentials);
        $this->setClient($client);
    }
    public function setClient(\S3IO\Aws2\Aws\Common\InstanceMetadata\InstanceMetadataClient $client = null)
    {
        $this->customClient = null !== $client;
        $this->client = $client ?: \S3IO\Aws2\Aws\Common\InstanceMetadata\InstanceMetadataClient::factory();
    }
    ...
    public function unserialize($value)
    {
        ...
        $this->client = $this->customClient ? unserialize($serialized['client']) : \S3IO\Aws2\Aws\Common\InstanceMetadata\InstanceMetadataClient::factory();
    }
    /**
