 ...
 */
class ChunkHash implements \S3IO\Aws2\Aws\Common\Hash\ChunkHashInterface
{
    /**
    ...
    {
        if (!$this->context) {
            throw new \S3IO\Aws2\Aws\Common\Exception\LogicException('You may not add more data to a finalized chunk hash.');
        }
