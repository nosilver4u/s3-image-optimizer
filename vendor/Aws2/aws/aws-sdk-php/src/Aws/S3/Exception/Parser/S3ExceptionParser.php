 ...
 */
namespace S3IO\Aws2\Aws\S3\Exception\Parser;
 ...
 */
class S3ExceptionParser extends \S3IO\Aws2\Aws\Common\Exception\Parser\DefaultXmlExceptionParser
{
    /**
     * {@inheritdoc}
     */
    public function parse(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    protected function parseHeaders(\S3IO\Aws2\Guzzle\Http\Message\RequestInterface $request, \S3IO\Aws2\Guzzle\Http\Message\Response $response, array &$data)
    {
