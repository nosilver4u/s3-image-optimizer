...
use S3IO\Aws2\Guzzle\Iterator\ChunkedIterator;
use S3IO\Aws2\Guzzle\Service\Command\CommandInterface;
abstract class AbstractSync extends \S3IO\Aws2\Guzzle\Common\AbstractHasDispatcher
{
    ...
    {
        $this->options = \S3IO\Aws2\Guzzle\Common\Collection::fromConfig($options, array('concurrency' => 10), array('client', 'bucket', 'iterator', 'source_converter'));
        $this->init();
    }
    ...
    public function transfer()
    {
        ...
        $iterator = new \S3IO\Aws2\Guzzle\Iterator\ChunkedIterator($this->options['iterator'], $this->options['concurrency']);
