...
class ChangedFilesIterator extends \FilterIterator
{
     ...
     */
    public function __construct(\Iterator $sourceIterator, \Iterator $targetIterator, \S3IO\Aws2\Aws\S3\Sync\FilenameConverterInterface $sourceConverter, \S3IO\Aws2\Aws\S3\Sync\FilenameConverterInterface $targetConverter)
    {
