...
class AcpBuilder
{
    ...
    {
        $this->owner = new \S3IO\Aws2\Aws\S3\Model\Grantee($id, $displayName ?: $id, \S3IO\Aws2\Aws\S3\Enum\GranteeType::USER);
        return $this;
    }
    /**
    ...
    {
        $grantee = new \S3IO\Aws2\Aws\S3\Model\Grantee($id, $displayName ?: $id, \S3IO\Aws2\Aws\S3\Enum\GranteeType::USER);
    ...
    {
        $grantee = new \S3IO\Aws2\Aws\S3\Model\Grantee($email, null, \S3IO\Aws2\Aws\S3\Enum\GranteeType::EMAIL);
        $this->addGrant($permission, $grantee);
        return $this;
    }
    /**
    ...
    {
        $grantee = new \S3IO\Aws2\Aws\S3\Model\Grantee($group, null, \S3IO\Aws2\Aws\S3\Enum\GranteeType::GROUP);
        $this->addGrant($permission, $grantee);
        return $this;
    }
    /**
     ...
     * @return $this
     */
    public function addGrant($permission, \S3IO\Aws2\Aws\S3\Model\Grantee $grantee)
    {
        $this->grants[] = new \S3IO\Aws2\Aws\S3\Model\Grant($grantee, $permission);
        return $this;
    }
    /**
    ...
    {
        return new \S3IO\Aws2\Aws\S3\Model\Acp($this->owner, $this->grants);
    }
}
