 ...
 */
namespace S3IO\Aws2\Aws\S3\Command;
 ...
 */
class S3Command extends \S3IO\Aws2\Guzzle\Service\Command\OperationCommand
{
    /**
    ...
    protected function process()
    {
        ...
        if ($response->getStatusCode() == 301) {
            $this->getClient()->getEventDispatcher()->dispatch('request.error', new \S3IO\Aws2\Guzzle\Common\Event(array('request' => $this->getRequest(), 'response' => $response)));
        }
        parent::process();
