...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \S3IO\Aws3\JmesPath\Lexer();
        $this->parser = new \S3IO\Aws3\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \S3IO\Aws3\JmesPath\Lexer();
    ...
    {
        $parser = new \S3IO\Aws3\JmesPath\Parser();
