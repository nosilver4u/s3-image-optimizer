...
namespace S3IO\Aws3\Aws\DefaultsMode;

use S3IO\Aws3\Aws\DefaultsMode\Exception\ConfigurationException;
class Configuration implements ConfigurationInterface
{
    ...
    public function __construct($mode = 'legacy')
    {
        ...
        $data = \S3IO\Aws3\Aws\load_compiled_json(__DIR__ . '/../data/sdk-default-configuration.json');
