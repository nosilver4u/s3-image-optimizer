...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = $config['client'] ?? \S3IO\Aws3\Aws\default_http_handler();
    ...
    {
        $isImdsV1Disabled = \S3IO\Aws3\Aws\boolean_value($this->ec2MetadataV1Disabled) ?? \S3IO\Aws3\Aws\boolean_value(ConfigurationResolver::resolve(self::CFG_EC2_METADATA_V1_DISABLED, self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED, 'bool', $this->config)) ?? self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED;
