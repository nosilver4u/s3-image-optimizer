 ...
 */
class AesEncryptingStream implements \S3IO\Aws3\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\S3IO\Aws3\Psr\Http\Message\StreamInterface $plainText, $key, \S3IO\Aws3\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
