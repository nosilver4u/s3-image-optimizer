...
use S3IO\Aws3\Aws\Crypto\AbstractCryptoClientV3;
use S3IO\Aws3\Aws\Crypto\EncryptionTraitV3;
use S3IO\Aws3\Aws\Crypto\AlgorithmSuite;
use S3IO\Aws3\Aws\Crypto\MaterialsProviderInterfaceV3;
...
use S3IO\Aws3\Aws\S3\MultipartUploader;
