...
trait CryptoParamsTrait
{
    ...
    {
        if (isset($result['Metadata'][\S3IO\Aws3\Aws\Crypto\MetadataEnvelope::CONTENT_KEY_V2_HEADER])) {
            return new \S3IO\Aws3\Aws\S3\Crypto\HeadersMetadataStrategy();
        }
        return new \S3IO\Aws3\Aws\S3\Crypto\InstructionFileMetadataStrategy($this->client, $instructionFileSuffix);
    }
        ...
        if (!empty($args['@MetadataStrategy'])) {
            ...
            if (is_string($args['@MetadataStrategy'])) {
                switch ($args['@MetadataStrategy']) {
                    case \S3IO\Aws3\Aws\S3\Crypto\HeadersMetadataStrategy::class:
                        return new \S3IO\Aws3\Aws\S3\Crypto\HeadersMetadataStrategy();
                    case \S3IO\Aws3\Aws\S3\Crypto\InstructionFileMetadataStrategy::class:
                        return new \S3IO\Aws3\Aws\S3\Crypto\InstructionFileMetadataStrategy($this->client, $instructionFileSuffix);
                    default:
