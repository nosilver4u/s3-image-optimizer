...
use S3IO\Aws3\Aws\S3\S3Transfer\Models\DownloadResult;
...
use S3IO\Aws3\Aws\S3\S3Transfer\Utils\StreamDownloadHandler;
use S3IO\Aws3\GuzzleHttp\Promise\Coroutine;
use S3IO\Aws3\GuzzleHttp\Promise\Create;
