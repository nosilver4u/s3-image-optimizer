...
class S3Client extends \S3IO\Aws3\Aws\AwsClient implements \S3IO\Aws3\Aws\S3\S3ClientInterface
{
    ...
    public function createPresignedRequest(\S3IO\Aws3\Aws\CommandInterface $command, $expires)
    {
        ...
        return $signer->presign(\S3IO\Aws3\Aws\serialize($command), $this->getCredentials()->wait(), $expires);
    }
    ...
    {
        \S3IO\Aws3\Aws\ClientResolver::_apply_api_provider($value, $args, $list);
