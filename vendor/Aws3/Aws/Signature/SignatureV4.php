...
use S3IO\Aws3\AWS\CRT\Auth\Signable;
use S3IO\Aws3\AWS\CRT\Auth\SignatureType;
use S3IO\Aws3\AWS\CRT\Auth\SignedBodyHeaderType;
use S3IO\Aws3\AWS\CRT\Auth\Signing;
use S3IO\Aws3\AWS\CRT\Auth\SigningAlgorithm;
use S3IO\Aws3\AWS\CRT\Auth\SigningConfigAWS;
use S3IO\Aws3\AWS\CRT\Auth\StaticCredentialsProvider;
use S3IO\Aws3\AWS\CRT\HTTP\Request;
use S3IO\Aws3\Aws\Exception\CommonRuntimeException;
