 ...
 */
class QueryParser extends \S3IO\Aws3\Aws\Api\Parser\AbstractParser
{
     ...
     *                                      output structure.
     */
    public function __construct(\S3IO\Aws3\Aws\Api\Service $api, \S3IO\Aws3\Aws\Api\Parser\XmlParser $xmlParser = null, $honorResultWrapper = true)
    {
        parent::__construct($api);
        $this->parser = $xmlParser ?: new \S3IO\Aws3\Aws\Api\Parser\XmlParser();
    ...
    public function __invoke(\S3IO\Aws3\Aws\CommandInterface $command, \S3IO\Aws3\Psr\Http\Message\ResponseInterface $response)
    {
        ...
        return new \S3IO\Aws3\Aws\Result($this->parser->parse($output, $xml));
    }
