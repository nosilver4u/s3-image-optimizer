...
namespace S3IO\Aws3\Aws\EndpointV2;

use S3IO\Aws3\Aws\Api\Serializer\RestSerializer;
...
trait EndpointV2SerializerTrait
{
    ...
    private function resolveProviderArgs($endpointProvider, $operation, $commandArgs, $clientArgs)
    {
        ...
        $providerArgs = $this->normalizeEndpointProviderArgs($endpointCommandArgs, $clientArgs, $contextParams, $staticContextParams);
        return $providerArgs;
    }
    /**
