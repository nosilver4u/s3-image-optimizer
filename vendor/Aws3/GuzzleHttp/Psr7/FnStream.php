 ...
 */
class FnStream implements \S3IO\Aws3\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\S3IO\Aws3\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
