...
use S3IO\Aws3\Psr\Http\Message\RequestFactoryInterface;
use S3IO\Aws3\Psr\Http\Message\RequestInterface;
use S3IO\Aws3\Psr\Http\Message\ResponseFactoryInterface;
use S3IO\Aws3\Psr\Http\Message\ResponseInterface;
use S3IO\Aws3\Psr\Http\Message\ServerRequestFactoryInterface;
use S3IO\Aws3\Psr\Http\Message\ServerRequestInterface;
use S3IO\Aws3\Psr\Http\Message\StreamFactoryInterface;
use S3IO\Aws3\Psr\Http\Message\StreamInterface;
use S3IO\Aws3\Psr\Http\Message\UploadedFileFactoryInterface;
use S3IO\Aws3\Psr\Http\Message\UploadedFileInterface;
use S3IO\Aws3\Psr\Http\Message\UriFactoryInterface;
