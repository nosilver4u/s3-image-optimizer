 ...
 */
class ServerRequest extends \S3IO\Aws3\GuzzleHttp\Psr7\Request implements \S3IO\Aws3\Psr\Http\Message\ServerRequestInterface
{
    /**
     * @var array
     */
    ...
    private static function createUploadedFileFromSpec(array $value)
    {
        ...
        return new \S3IO\Aws3\GuzzleHttp\Psr7\UploadedFile($value['tmp_name'], (int) $value['size'], (int) $value['error'], $value['name'], $value['type']);
    }
    /**
    ...
    {
        $uri = new \S3IO\Aws3\GuzzleHttp\Psr7\Uri('');
