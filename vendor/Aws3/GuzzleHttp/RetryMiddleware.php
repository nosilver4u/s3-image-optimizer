...
class RetryMiddleware
{
     ...
     * @return mixed
     */
    private function onFulfilled(\S3IO\Aws3\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return callable
     */
    private function onRejected(\S3IO\Aws3\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return self
     */
    private function doRetry(\S3IO\Aws3\Psr\Http\Message\RequestInterface $request, array $options, \S3IO\Aws3\Psr\Http\Message\ResponseInterface $response = null)
    {
