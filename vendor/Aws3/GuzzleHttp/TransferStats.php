...
final class TransferStats
{
     ...
     */
    public function __construct(\S3IO\Aws3\Psr\Http\Message\RequestInterface $request, \S3IO\Aws3\Psr\Http\Message\ResponseInterface $response = null, $transferTime = null, $handlerErrorData = null, $handlerStats = [])
    {
