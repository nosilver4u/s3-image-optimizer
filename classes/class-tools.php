...
class Tools extends Base {
	...
	public function tools_script( $hook ) {
		...
		if ( ! empty( $_REQUEST['s3io_reset_bulk'] ) && ! empty( $_REQUEST['s3io_wpnonce'] ) && \wp_verify_nonce( \sanitize_key( $_REQUEST['s3io_wpnonce'] ), 's3io-bulk-reset' ) && \current_user_can( 'manage_options' ) ) {
